...
system.time({simulationstl = wrap_cvodes(times = 1:1000, 
                     states_ = 1:5, 
                     parameters_ = 1, 
                     ...
                     settings = list(rtol = 1e-6,
                      ...
                      minimum = -1e-4, positive = 0,
                      which_states = 1, which_observed = 1,
                      stability = T, sensitivity = F, sens_type = "staggered", sens_fun = F,
                      which_sens = 1L, sens_error = T, reset = 10L,which_positive = 1L:5L), 
